...
### คำนำ
อกสารนี้เป็นการนำเสนอไวยากรณ์ระดับพื้นฐานของภาษาเอสเปรันโตเท่านั้น เรียบเรียง จาก Konciza Gramatiko de Esperanto ฉบับภาษาเอสเปรันโต ของเว็บไซต์เรียน ภาษาเอสเปรันโต lernu.net ในเวอร์ชั่นเก่า

อย่างไรก็ตามเอกสารนี้ได้จัดทำโดยเวลาอันจำกัด เป็นไปไม่ได้เลยที่จะไม่มีข้อบกพร่อง  หากท่านพบข้อบกพร่องหรือมีข้อเสนอแนะอื่น ๆ ขอโปรดชี้แนะมายังกระผม เพื่อที่ครั้งต่อไปจะ ได้ทำให้ดียิ่งขึ้น

วรุฒ บุญประเสริฐ/ 25-09-2559

แก้ไขครั้งที่สอง 05-03-2561

MD Formatted 4-05-2565
...
|ĝis 	|จนกระทั่ง,  จนกระทั่งถึง , จนถึง|	Mi iras ĝis la domo. - ฉันกำลังไปจนถึง บ้าน|
...
เราสามารถแทนคำบุพบทโดยใช้ตัวลงท้าย -n สำหรับการใช้แสดงเกี่ยวกับเวลาหรือ ปริมาณ
...
[^1]: ใน Plena Manlibro de Esperanta Gramatiko (= PMEG) (2016) กลุ่มคำเหล่านี้เรียนว่า Tabelvorto แปลตรงตรวคือ คำตาราง โดยให้เหตุผลว่า เรามักจะเห็นกลุ่มคำเหล่านี้ในรูปแบบของตาราง
